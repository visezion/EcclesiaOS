                ...
                <section class="dashboard-card p-0">
                    ...
                    <div class="overflow-x-auto">
                        <table class="table-compact min-w-[1100px]">
                            <thead><tr><th>Name</th><th>Age Group</th><th>Campus</th><th>Guardian</th><th>Consent</th><th>Check-in</th><th>Pickup</th><th>Status</th><th class="text-right">Actions</th></tr></thead>
                            <tbody>
                                    ...
                                    <tr>
                                        <td colspan="9" class="bg-slate-50/70">
                                            <form id="youth-update-{{ $record->id }}" method="POST" action="{{ route('children-youth.update', $record) }}" class="grid gap-2 py-3 lg:grid-cols-[1fr_1fr_140px_150px_150px_150px_140px]">
                                                ...
                                                <select name="campus_id" class="rounded-lg border border-slate-200 px-3 py-2 text-sm"><option value="">Campus</option>@foreach($campuses as $campus)<option value="{{ $campus->id }}" @selected($record->campus_id === $campus->id)>{{ $campus->name }}</option>@endforeach</select>
