                ...
                <div class="space-y-3 p-3">
                    ...
                    <div class="grid gap-3 md:grid-cols-[130px_150px_1fr]">
                        ...
                        <label class="text-xs font-medium text-slate-600">Campus
                            <select name="campus_id" class="mt-1 w-full rounded-lg border border-slate-200 px-3 py-2 text-sm"><option value="">All {{ $terminology['campus_plural'] }}</option>@foreach($campuses as $campus)<option value="{{ $campus->id }}" @selected(old('campus_id', $selected?->campus_id) == $campus->id)>{{ $campus->name }}</option>@endforeach</select>
                        </label>
