            ...
            <main class="min-w-0">
                <form id="system-settings-form" method="POST" action="{{ route('settings.system.update') }}" enctype="multipart/form-data" class="dashboard-card space-y-4">
                    ...
                    <div x-show="more" x-cloak class="grid gap-4 lg:grid-cols-3">
                        ...
                        <section id="notifications" class="rounded-lg border border-slate-200 p-4"><h3 class="mb-3 text-sm font-semibold text-slate-950">Notifications</h3><p class="text-sm text-slate-500">Notification preferences are managed per user and per channel in Communications.</p><a href="{{ route('communications.preferences') }}" class="mt-3 inline-flex text-sm font-medium text-violet-600">Open Notification Preferences</a></section>
                        ...
                        <section id="integrations" class="rounded-lg border border-slate-200 p-4"><h3 class="mb-3 text-sm font-semibold text-slate-950">Integrations & API</h3><p class="text-sm text-slate-500">Email, SMS, WhatsApp, Push, and in-app providers are managed in the dedicated communication integration center.</p><a href="{{ route('communications.integrations') }}" class="mt-3 inline-flex text-sm font-medium text-violet-600">Open Communication Integrations</a></section>
