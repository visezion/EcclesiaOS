                ...
                <section class="dashboard-card">
                    ...
                    <div class="grid gap-4 lg:grid-cols-[1fr_190px]">
                        <div class="grid gap-4">
                            <div class="grid gap-3 md:grid-cols-3"><label class="space-y-1 text-sm font-medium text-slate-600">First Name *<input name="first_name" required value="{{ old('first_name') }}" class="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm"></label><label class="space-y-1 text-sm font-medium text-slate-600">Middle Name<input name="middle_name" value="{{ old('middle_name') }}" class="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm"></label><label class="space-y-1 text-sm font-medium text-slate-600">Last Name *<input name="last_name" required value="{{ old('last_name') }}" class="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm"></label></div>
                            <div class="grid gap-3 md:grid-cols-3"><label class="space-y-1 text-sm font-medium text-slate-600">Gender<select name="gender" class="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm"><option>Male</option><option>Female</option><option>Prefer not to say</option></select></label><label class="space-y-1 text-sm font-medium text-slate-600">Date of Birth<input name="date_of_birth" type="date" class="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm"></label><label class="space-y-1 text-sm font-medium text-slate-600">Status *<select name="status" required class="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm"><option value="active">Active</option><option value="new">New Member</option><option value="follow-up">Follow-up</option><option value="inactive">Inactive</option></select></label></div>
                            ...
                            <label class="space-y-1 text-sm font-medium text-slate-600">Address<textarea name="address" rows="2" class="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm">{{ old('address') }}</textarea></label>
                        </div>
