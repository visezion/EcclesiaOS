@php
    ...
    $sidebarIconTones = [
        ...
        'website-studio.index' => 'text-violet-400',
        'website-studio.sections' => 'text-fuchsia-400',
        'website-studio.sections.create' => 'text-indigo-400',
        'website-studio.media' => 'text-cyan-400',
