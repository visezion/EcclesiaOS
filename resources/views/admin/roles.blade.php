    ...
    @php
        ...
        $permissionDefinitions = collect([
            ...
            'Operations' => [
                ...
                ['permission' => 'use messages', 'label' => 'Message Center Access', 'help' => 'Open the Message Center and participate in permitted conversations.', 'icon' => 'messages-square', 'class' => 'bg-violet-50 text-violet-600'],
                ['permission' => 'send messages', 'label' => 'Send Messages', 'help' => 'Create conversations, reply, attach files, and schedule messages.', 'icon' => 'send', 'class' => 'bg-blue-50 text-blue-600'],
                ['permission' => 'create message groups', 'label' => 'Create Message Groups', 'help' => 'Create group, ministry, campus, role, and leadership conversations.', 'icon' => 'users-round', 'class' => 'bg-emerald-50 text-emerald-600'],
                ['permission' => 'manage message participants', 'label' => 'Manage Message Participants', 'help' => 'Add, remove, promote, and demote conversation participants.', 'icon' => 'user-check', 'class' => 'bg-teal-50 text-teal-600'],
                ['permission' => 'forward messages', 'label' => 'Forward Messages', 'help' => 'Forward permitted messages and their attachments to other recipients.', 'icon' => 'repeat-2', 'class' => 'bg-orange-50 text-orange-600'],
                ['permission' => 'export message history', 'label' => 'Export Message History', 'help' => 'Download authorized conversation history for reporting or compliance.', 'icon' => 'download', 'class' => 'bg-slate-50 text-slate-600'],
                ['permission' => 'view sensitive messages', 'label' => 'View Sensitive Messages', 'help' => 'Access leadership and restricted conversations when included as a participant.', 'icon' => 'lock-keyhole', 'class' => 'bg-rose-50 text-rose-600'],
                ['permission' => 'administer messages', 'label' => 'Administer Messages', 'help' => 'Manage restricted replies, conversation status, participants, and message oversight.', 'icon' => 'shield-check', 'class' => 'bg-violet-50 text-violet-600'],
