...
final class CommunicationDemoSeeder extends Seeder
{
    ...
    private function providerSettings(Church $church): void
    {
        $settings = [
            ...
            'whatsapp' => ['Zender WhatsApp Gateway', 'Verified Business +1 (833) 123-4567', 90],
            ...
            CommunicationProviderSetting::query()->updateOrCreate(
                ...
                [
                    ...
                    'settings' => [
                        ...
                        'api_key_encrypted' => in_array($channel, ['sms', 'whatsapp'], true) ? encrypt('demo-zender-api-token') : null,
                        'api_key_last_four' => in_array($channel, ['sms', 'whatsapp'], true) ? 'oken' : null,
                    ],
