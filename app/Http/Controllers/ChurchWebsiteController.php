    ...
    private function normalizeSectionComponents(?string $encoded): array
    {
        ...
        return collect($components)->filter(fn ($component): bool => is_array($component))->map(function (array $component): array {
            ...
            return [
                ...
                'font_size' => in_array($type, ['heading', 'text'], true) && (int) ($component['font_size'] ?? 0) > 0 ? max(10, min(120, (int) $component['font_size'])) : 0,
                ...
                'divider_justify' => $type === 'divider' && in_array($component['divider_justify'] ?? null, ['left', 'center', 'right'], true) ? $component['divider_justify'] : 'left',
