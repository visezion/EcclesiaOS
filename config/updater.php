...
return [
    ...
    'current_link' => env('UPDATER_CURRENT_LINK', env('APP_CONTAINERIZED', false) ? base_path('.managed/current') : ''),
    'releases_path' => env('UPDATER_RELEASES_PATH', env('APP_CONTAINERIZED', false) ? base_path('.managed/releases') : ''),
    'shared_path' => env('UPDATER_SHARED_PATH', env('APP_CONTAINERIZED', false) ? base_path('.managed/shared') : ''),
